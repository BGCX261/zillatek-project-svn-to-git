...
<div class="span-22 prepend-1 append-1">
    ...
    <div class="span-6 colborder">
		<h2 class="title"><a style="text-decoration: none;" href="http://tnx-home.com/picture-gallery">Picture gallery</a></h2>
		<ion:articles from="picture-gallery" limit="2">
    ...
    <div class="span-15 last">
    	...
    	-->
    	<ion:articles from="blog" limit="3">
